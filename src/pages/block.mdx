export const description =
  'On this page, we’ll dive into the different block endpoints you can use to manage block programmatically.'

# Block

Block are how you share things in Protocol — they allow you to send all sorts of files to your contacts and groups. On this page, we'll dive into the different block endpoints you can use to manage block programmatically. We'll look at how to query, upload, update, and delete block. {{ className: 'lead' }}

## The block model

The block model contains all the information about the files you send to your contacts and groups, including the name, type, and size.
