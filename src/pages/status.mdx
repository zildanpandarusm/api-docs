...
Status are how you share things in Protocol — they allow you to send all sorts of files to your contacts and groups. On this page, we'll dive into the different status endpoints you can use to manage status programmatically. We'll look at how to query, upload, update, and delete status. {{ className: 'lead' }}

## The status model

The status model contains all the information about the files you send to your contacts and groups, including the name, type, and size.
