...
<Properties>
  ...
  <Property name="to_user_id" type="object">
    The user id for the user who will receive the message.
  </Property>
  <Property name="message_sent" type="string">
    The contents of the message sent from the user.
  </Property>
  <Property name="message_received" type="string">
    The contents of the message received by the user.
  </Property>
  <Property name="reactions" type="array">
    An array of reaction objects associated with the message.
  </Property>
  <Property name="is_favorite" type="boolean">
    Whether or not the message has been favorited.
  </Property>
...
<Row>
  ...
  <Col sticky>
    ...
    ```json {{ title: 'Response' }}
    {
      ...
      "data": [
        {
          "_id": "SIuAFUNKdSYHZF2w",
          "conversation_id": "xgQQXg3hrtjh7AvZ",
          "to_user_id": "WAz8eIbvDR60rouK",
          "message_sent": "It’s a nice night for a neck injury.",
        ...
        },
        {
          ...
          "conversation_id": "rjrxy8yFFRjyhWA6",
          "to_user_id": "HsrFCsy7ILVckq56",
          "message_sent": null,
          "message_received": "It’s a nice night for a neck injury",
          "reactions": [],
          "is_favorite": false,
          "read_at": 705103200,
          "created_at": 692233200,
...
<Row>
  ...
  <Col sticky>
    ...
    await client.messages.send({
      conversation_id: 'xgQQXg3hrtjh7AvZ',
      to_user_id: 'inEIRvzjC6YLMX3o',
      message_sent: 'You’re what the French call ‘les incompetents.’',
    })
    ```
...
<Row>
  ...
  <Col sticky>
    ...
    ```json {{ title: 'Response' }}
    {
      ...
      "conversation_id": "xgQQXg3hrtjh7AvZ",
      "to_user_id": "WAz8eIbvDR60rouK",
      "message_sent": "I’m traveling with my dad. He’s at a meeting. I hate meetings.",
      "message_received": null,
      "reactions": [],
      "is_favorite": false,
      "read_at": 705103200,
...
<Row>
  ...
  <Col sticky>
    ...
    ```json {{ title: 'Response' }}
    {
      "_id": "SIuAFUNKdSYHZF2w",
      "conversation_id": "xgQQXg3hrtjh7AvZ",
      "to_user_id": "JAz8eIbvDR60rouK",
      "message_sent": null,
      "message_received": "I'm not apologizing. I'd rather kiss a toilet seat.",
      "reactions": [
        {
          "red_angry_face": [
            "KateMcCallister"
